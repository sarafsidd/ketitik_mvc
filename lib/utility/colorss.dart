...
class MyColors {
  ...
  static Color themeBlackTrans = const Color.fromRGBO(
      10, 10, 10, 0.8470588235294118);

  static Color blankTrans = const Color.fromRGBO(3, 3, 3, 0.7098039215686275);
  static Color whiteTransTrans = const Color.fromRGBO(
      7, 7, 7, 0.6509803921568628);
  static Color themeColorTrans = const Color.fromRGBO(
      255, 222, 89, 0.7058823529411765);
}
